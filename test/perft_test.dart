...
void main() {
  group('perft test', () {
    ...
    */
    ...
    test('tricky test', () async {
      final tests = Parser()
          .parse(await File('test/resources/tricky.perft').readAsString());
